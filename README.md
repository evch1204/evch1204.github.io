...
│   │                    # its page, except the project case studies, which
│   │                    # live in projects.ts; contributions.json is
│   │                    # generated by `npm run contributions`
│   │   ├── site.ts      # Name, email, links, resume
│   │   ├── projects.ts  # Cards and case studies
│   │   ├── experience.ts
│   │   ├── skills.ts
│   │   ├── tech.tsx
│   │   └── contributions.json
│   ├── components/      # Section, SectionHeading, Eyebrow, Tag, Chip,
│   │                    # PillLink, Modal, SiteFooter
...
- **Copy:** page prose under `src/pages/`; project case studies in `src/content/projects.ts`, with a project's pictures in `src/assets/images/projects/<id>/`
