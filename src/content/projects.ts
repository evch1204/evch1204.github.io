  ...
  },
  {
    ...
    caseStudy: {
      hero: {
        ...
        caption: 'Planner, first open — tap the map to drop a start point',
      },
      summary:
      ...
      sections: [
        ...
        },
        {
          heading: 'Notes',
          body: [
            'Two gestures carry most of the editing — drag a point to adjust the line, shift-click a point to remove it — and the hint card on first open exists so they are discoverable. The screenshots here are the public, signed-out views captured in September 2026.',
          ],
        },
      ],
      details: [
      ...
      sections: [
        ...
        },
        {
          ...
          figure: {
            ...
            caption: 'The host dashboard and its three-step getting-started list',
          },
        },
        {
          heading: 'Notes',
          body: [
            'BookWithMe is one of the app.space tools built at DeepSpace, in React and TypeScript. The dashboard capture here is the public, signed-out view from September 2026; the booking page is the example meeting.',
          ],
        },
      ],
      details: [{ label: 'Context', value: 'DeepSpace' }],
    ...
    caseStudy: {
      ...
      sections: [
        ...
        },
        {
          heading: 'Notes',
          body: [
            'Docs is one of the app.space tools built at DeepSpace, in React and TypeScript. The library capture here is the public, signed-out view from September 2026.',
          ],
        },
      ],
      details: [{ label: 'Context', value: 'DeepSpace' }],
